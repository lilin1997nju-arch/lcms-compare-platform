...
const statusText={{identified_direct_precursor:'直接前体鉴定',identified_isotope_envelope:'同位素包络对应',identified_charge_state_envelope:'电荷态包络对应',tentative_component_consensus_identification:'组件多电荷/同位素联合推测',tentative_backbone_sequence_support:'未知质量偏移骨架序列推测',tentative_truncation_sequence_support:'截断骨架序列推测',tentative_sequence_region_candidate:'局部 b/y 序列区段候选',tentative_feature_consensus_identification:'单 Feature 共识谱推测',tentative_feature_guided_identification:'MS1 引导定向推测',tentative_feature_open_mass_identification:'单 Feature 开放质量搜索',selected_precursor_unidentified:'已采集前体，未鉴定',coisolated_ms2_unresolved:'隔离窗覆盖，未定性',no_ms2_acquired:'未采集 MS2'}};
...
def main() -> None:
    ...
    print(f"MS1 significant Feature evidence: {feature_ms2_summary}")
